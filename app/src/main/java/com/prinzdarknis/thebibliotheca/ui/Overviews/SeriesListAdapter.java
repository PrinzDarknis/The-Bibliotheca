...
public class SeriesListAdapter extends BaseAdapter {
    ...
    public SeriesListAdapter(ArrayList<Series> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.row_series, parent, false);
        ...
        holder.infoText.setText(s.infoText);

        Bitmap image = ProgramLogic.getInstance().getImage(s);
        if (image != null)
